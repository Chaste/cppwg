...
class CppHeaderCollectionWriter:
    ...
    typedefs (e.g. typedef AbstractLinearPde2_2 AbstractLinearPde<2,2>) for all
    ...
    def __init__(
        ...
        # Populate the class and free function dictionaries from the package info
    ...
    def write(self):
        ...
        # Add the template instantiations e.g. `template class AbstractLinearPde<2,2>;`
        self.hpp_collection_string += "\n// Instantiate Template Classes \n"

        for module_info in self.package_info.module_info_collection:
            for class_info in module_info.class_info_collection:
                # Class full names eg. ["AbstractLinearPde<2,2>", "AbstractLinearPde<3,3>"]
        ...
        # Add typdefs for nice naming e.g. `typedef AbstractLinearPde2_2 AbstractLinearPde<2,2>;`
        ...
        for module_info in self.package_info.module_info_collection:
            for class_info in module_info.class_info_collection:
                ...
                # Class short names eg. ["AbstractLinearPde2_2", "AbstractLinearPde3_3"]
