...
# Do-not-edit banner prepended to the emitted package model (YAML comments,
# ignored on load), mirroring the banner on the generated wrapper sources so the
# committed model reads clearly as a generated artifact.
