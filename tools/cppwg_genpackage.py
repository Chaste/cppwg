...
``cppwg.utils.package_model``). This standalone script turns that model, plus a
small package-layout file, into a ``_generated.py`` per Python subpackage: the
...
Usage::
    ...
    cppwg_genpackage.py --model wrapper/cppwg_package_model.yaml --layout package_layout.yaml
"""
